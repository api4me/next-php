...
/*{{{ variable */
     ...
     */
    private $separator = ' ';
    private $tag_open = '<div class="pagination"><ul>';
    private $tag_close = '</ul></div>';
    private $prev_link_text = '&lt;';     
    private $prev_link_tag_open = '<li id="prev_link">';
    private $prev_link_tag_close = '</li>';
    private $next_link_text = '&gt;';     
    private $next_link_tag_open = '<li id="next_link">';
    private $next_link_tag_close = '</li>';
    private $first_link_text = '&laquo;';
    private $first_link_tag_open = '<li id="first_link">';
    private $first_link_tag_close = '</li>';
    private $last_link_text = '&raquo;';
    private $last_link_tag_open = '<li id="last_link">';
    private $last_link_tag_close = '</li>';
/*}}}*/
/*{{{ construct */
    /**
     * constructor
...
/*{{{ get_links */
    ...
    public function get_links() {
        ...
        if ($this->show_numbers) {
            ...
            // current page
            $links[] = '<li class="active"><a>' . $this->page . '</a></li>';
