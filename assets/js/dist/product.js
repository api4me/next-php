...
define("ratchet", ["hack"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.ratchet;
    };
}(this)));
...
define('app/h5',['zepto', 'ratchet'], function($, R) {
    return {
        'root': function() {
...
define('app/home',['zepto', 'ratchet', 'underscore', 'app/h5', 'app/wxapi'], function($, R, _, H5, Wxapi){
    var view = function() {
    	Wxapi.ready(function(Api) {
...
define('app/delivery',['zepto', 'ratchet', 'underscore', 'app/h5', 'app/wxapi'], function($, R, _, H5, Wxapi){
    var view = function() {
...
define('app/goods',['zepto', 'ratchet', 'underscore', 'app/h5', 'app/wxapi'], function($, R, _, H5, Wxapi){
    var view = function() {
...
define('app/address',['zepto', 'ratchet', 'underscore', 'app/h5'], function($, R, _, H5){
    var view = function() {
...
define('app/help',['zepto', 'ratchet', 'underscore', 'app/h5'], function($, R, _, H5){
    var view = function() {
...
define('app/coupon',['zepto', 'ratchet', 'underscore', 'app/h5', 'app/wxapi'], function($, R, _, H5, Wxapi){
    var view = function() {
...
define('app/article',['zepto', 'ratchet', 'underscore', 'app/h5', 'app/wxapi'], function($, R, _, H5, Wxapi){
    var view = function() {
...
define('app/invite',['zepto', 'ratchet', 'underscore', 'app/h5', 'app/wxapi'], function($, R, _, H5, Wxapi){
    var view = function() {
...
define('app/gift',['zepto', 'ratchet', 'underscore', 'app/h5', 'app/wxapi'], function($, R, _, H5, Wxapi){
    var view = function() {
